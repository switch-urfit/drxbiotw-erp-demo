...
import { ProductionGanttPage } from './pages/production-gantt';

export const routes: Routes = [
  { path: '', pathMatch: 'full', redirectTo: 'dashboard' },
  { path: 'dashboard', component: DashboardPage, title: '儀表板 — DRX 排程升級展示' },
  { path: 'delivery',  component: DeliveryPage,  title: '交期追蹤 — DRX 排程升級展示' },
  { path: 'gantt',     component: ProductionGanttPage, title: '生產甘特圖 — DRX 排程升級展示' },
